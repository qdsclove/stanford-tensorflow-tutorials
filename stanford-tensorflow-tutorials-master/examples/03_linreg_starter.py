...
w = tf.get_variable(name="weight_1",dtype=tf.float32, initializer=tf.constant(0.0))
#u = tf.get_variable(name="weight_2", initializer=tf.constant(0.0))
...
# Y_predicted = tf.multiply(X * X, w) + tf.multiply(X, u) + b
Y_predicted = tf.multiply(X, w) + b
